Fonctionnalité: OPCA 3+
    Cas d'usage pour l'organisme OPCA 3+.


Scénario: période de professionnalisation CDI avec IDCC Ameublement et bois
...
Scénario: période de professionnalisation CDI avec IDCC "Matériaux pour la Construction et l'Industrie"
    ...
    Et la rémunération du bénéficiaire vaut 1400
    Et le type de contrat du bénéficiaire vaut «CDI»
    Et l'IDCC de l'établissement du bénéficiaire vaut «211»
    Et la durée en heures de la formation vaut 100
    Et la durée en mois de la formation vaut 10
    Quand je demande un calcul de financement
    Quand je sélectionne le financement «Période de professionnalisation sur son temps de travail»
...
Scénario: période de professionnalisation CDI avec IDCC Papiers Cartons
    Soit un bénéficiaire et une formation
    Et c'est un bénéficiaire de droit privé
    Et la rémunération du bénéficiaire vaut 1400
    Et le type de contrat du bénéficiaire vaut «CDI»

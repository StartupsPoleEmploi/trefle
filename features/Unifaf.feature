...
Scénario: Cas nominal d'une période de professionnalisation CDI
    ...
    Alors l'organisme à contacter est «Unifaf»
    Et le plafond de prise en charge vaut 1100
    Et la rémunération applicable vaut 1400



Scénario: période de professionnalisation CDI filière éducative
    Soit un bénéficiaire et une formation
    Et c'est un bénéficiaire de droit privé
    Et la rémunération du bénéficiaire vaut 1700
    Et le type de contrat du bénéficiaire vaut «CDI»
    Et l'IDCC de l'établissement du bénéficiaire vaut «29»
    Et la durée en heures de la formation vaut 100
    Et la durée en mois de la formation vaut 10
    ...
    Et la rémunération applicable vaut 1700

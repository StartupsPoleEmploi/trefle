...
@pytest.mark.parametrize('input,expected', [
     ...
     ("sessions.0.eligibilite-cpf.region-insee//type=SALARIE", []),
     ("sessions.0.eligibilite-cpf.region-insee//type=DE|TOUTPUBLIC", ["24"]),
     ("sessions.missing", []),
     ("sessions.0.eligibilite-cpf.branches//type=SALARIE.[]", ['23.61Z',
                                                               '43.99E',
                                                               '01.62Z',
                                                               '96.04Z',
                                                               '96.09Z',
